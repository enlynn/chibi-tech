...
void gpu_mesh_manger::Deinit(GpuFrameCache* FrameCache)
{
    ForRange(u32, i, cTotalAllowedMeshes)
    {
...
void gpu_mesh_manger::ReleaseMesh(gpu_mesh_id Id, GpuFrameCache* FrameCache)
{
...
void gpu_mesh_manger::GetDrawData(std::vector<gpu_draw_data>& DrawList, gpu_mesh_flags FilterFlags)
{
}
#endif
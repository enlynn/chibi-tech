...
VK_INSTANCE_LEVEL_FUNCTION( vkGetPhysicalDeviceFormatProperties2 )
VK_INSTANCE_LEVEL_FUNCTION( vkGetPhysicalDeviceImageFormatProperties2 )
VK_INSTANCE_LEVEL_FUNCTION( vkGetPhysicalDeviceMemoryProperties2 )
VK_INSTANCE_LEVEL_FUNCTION( vkGetPhysicalDeviceProperties2 )
VK_INSTANCE_LEVEL_FUNCTION( vkGetPhysicalDeviceQueueFamilyProperties2 )
VK_INSTANCE_LEVEL_FUNCTION( vkGetPhysicalDeviceSparseImageFormatProperties2 )
...
VK_INSTANCE_LEVEL_FUNCTION_FROM_EXTENSION( vkCreateWaylandSurfaceKHR, VK_KHR_XLIB_SURFACE_EXTENSION_NAME )
#endif
...
VK_DEVICE_LEVEL_FUNCTION( vkGetDeviceBufferMemoryRequirements )
VK_DEVICE_LEVEL_FUNCTION( vkGetDeviceImageMemoryRequirements )
VK_DEVICE_LEVEL_FUNCTION( vkCmdBlitImage2 )
